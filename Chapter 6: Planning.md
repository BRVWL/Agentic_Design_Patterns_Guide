...
The final output is not merely a concatenated list of findings but a structured, multi-page report. During the synthesis phase, the model performs a critical evaluation of the collected information, identifying major themes and organizing the content into a coherent narrative with logical sections. The report is designed to be interactive, often including features like an audio overview, charts, and links to the original cited sources, allowing for verification and further exploration by the user. This entire process transforms a simple query into a comprehensive, synthesized body of knowledge.
...
![Planning design pattern](./imgs/unnamed-6.jpg)
_Planning design pattern_
...
- Large Language Models can perform planning by generating step-by-step approaches based on task descriptions.
